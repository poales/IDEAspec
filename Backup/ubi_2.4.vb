...
Friend Class DMK_v1
    ...
    Private Sub SaveToChrisBlaster(ByRef Current_Protocol As Short, ByVal memory_index As Integer, ByRef Number_Loops() As Short, ByRef Intensity(,) As Short, ByRef Number_Pulses(,) As Short, ByRef Number_Measuring_Lights() As Short, ByRef Measuring_Light(,) As Short, ByRef Measuring_Interval(,,) As String, ByRef Primary_Gain(,) As Short, ByRef reference_gain(,) As Short, ByRef Measuring_Pulse_Duration() As String, ByRef Gain As Integer, ByRef In_Channel As Short, ByRef points As Integer, ByRef data_time() As Single, ByRef Xe_Flash(,) As Short, ByRef q_switch(,) As Short, ByVal M_Far_Red(,) As Short, ByVal M_Blue_actinic(,) As Short, ByVal pre_pulse(,) As Short, ByVal pre_pulse_time(,) As String, ByVal Pre_Delay(,) As String, ByVal m_take_data(,) As Short)
        ...
        program.laser = laser
        program.Measuring_Pulse_Duration = Measuring_Pulse_Duration(Current_Protocol)
        ...
        program.Ref_Channel = ref_channel
        ...
        If Not programed_successfully Then
            MessageBox.Show("There was an error while programming protocol " & Current_Protocol & " to the ChrisBlaster (memory address " & memory_index & ").", _
                "Error!")
            System.Windows.Forms.Application.DoEvents()
        End If
    ...
    Private Sub Multi_Trace_from_FPGA(ByRef Current_Protocol As Short, ByVal memory_index As Integer, ByRef Number_Loops() As Short, ByRef Intensity(,) As Short, ByRef Number_Pulses(,) As Short, ByRef Number_Measuring_Lights() As Short, ByRef Measuring_Light(,) As Short, ByRef Measuring_Interval(,,) As String, ByRef Primary_Gain(,) As Short, ByRef reference_gain(,) As Short, ByRef Measuring_Pulse_Duration() As String, ByRef Gain As Integer, ByRef In_Channel As Short, ByRef points As Integer, ByRef data_time() As Single, ByRef Xe_Flash(,) As Short, ByRef q_switch(,) As Short, ByVal M_Far_Red(,) As Short, ByVal M_Blue_actinic(,) As Short, ByVal pre_pulse(,) As Short, ByVal pre_pulse_time(,) As String, ByVal Pre_Delay(,) As String, ByVal m_take_data(,) As Short)
        ...
        Time_Out_Time = data_time(data_time.Length - 2) ' time point of last data point
        ...
        CBCount = points * 4  'highchannel-lowchannel
        ...
        If (Not cblaster.StartRunningProtocol(memory_index)) Then
            MessageBox.Show("Protocol " & Current_Protocol & " from memory index " & memory_index & " failed to run or timed out.")
            System.Windows.Forms.Application.DoEvents()
        End If
    ...
    Private Sub Multi_Trace(ByRef Current_Protocol As Short, ByRef Number_Loops() As Short, ByRef Intensity(,) As Short, ByRef Number_Pulses(,) As Short, ByRef Number_Measuring_Lights() As Short, ByRef Measuring_Light(,) As Short, ByRef Measuring_Interval(,,) As String, ByRef Primary_Gain(,) As Short, ByRef reference_gain(,) As Short, ByRef Measuring_Pulse_Duration() As String, ByRef Gain As Integer, ByRef In_Channel As Short, ByRef points As Integer, ByRef data_time() As Single, ByRef Xe_Flash(,) As Short, ByRef q_switch(,) As Short, ByVal M_Far_Red(,) As Short, ByVal M_Blue_actinic(,) As Short, ByVal pre_pulse(,) As Short, ByVal pre_pulse_time(,) As String, ByVal Pre_Delay(,) As String, ByVal m_take_data(,) As Short)
        ...
        If (Not cblaster.StartRunningProtocol(Current_Protocol)) Then
            MessageBox.Show("Protocol " & Current_Protocol & " failed to run or timed out.")
            System.Windows.Forms.Application.DoEvents()
        End If
...
skipit:
        ...
        While Script_Counter < Total_Script_Count And Halt_Script = False
            ...
            ElseIf C_Script = "upload_protocol" Or C_Script = "upload" Then
                ...
                If ForReal Then
                    Call SaveToChrisBlaster(Current_Protocol, memory, M_Number_Loops, M_Intensity, M_Number_Pulses, M_Number_Measuring_Lights, M_Measuring_Light, L_Measuring_Interval, M_Primary_Gain, M_Reference_Gain, Measuring_Pulse_Duration, Gain(Current_Protocol), In_Channel(Current_Protocol), points, data_time, Xe_Flash, q_switch, M_Far_Red, M_Blue_Actinic, Pre_Pulse, Pre_Pulse_Time, Pre_Delay, M_Take_Data)
                    System.Windows.Forms.Application.DoEvents()
                End If
...
get_out:
    ...
    Private Sub Simmer(ByVal number_pulses As Integer, ByVal q_switch As String, ByVal simmer_q_switch As Short)
        ...
        If Not cblaster.ExecuteProtocol(0, (Protocol.TimeInSeconds("5u") + Protocol.TimeInSeconds(q_switch) + _
            ...
            'Scrolling text box fix: make the box jump to the bottom after adding an item
            List1.TopIndex = List1.Items.Count - 1
            MessageBox.Show("Error occured while programming the ChrisBlaster", "FPGA Communication Error")
            System.Windows.Forms.Application.DoEvents()
        End If
